...
//list_add jugar si qieres una cola o pila
//al querer una cola añades al final y sacas del principio
 ...
 *
 * Insert a new entry after the specified head. despues del head
 ...
 *
 * Insert a new entry before the specified head. antes del head
