...
//cada entrada esta vinculada a un task_struct
  
page_table_entry dir_pages[NR_TASKS][TOTAL_PAGES]   //Por cada proceso
  __attribute__((__section__(".data.task")));

page_table_entry pagusr_table[NR_TASKS][TOTAL_PAGES]  //Por cada proceso
  __attribute__((__section__(".data.task")));
